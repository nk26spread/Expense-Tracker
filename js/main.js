...
addTransction.addEventListener("click", (e) => {
  ...
  // Update the income, expenses, and savings dynamically
  updateFinancials();
...
// Function to update financials (Income, Spending, Saving)
function updateFinancials() {
  let income = document.getElementById("income");
  let spend = document.getElementById("expenses");
  let save = document.getElementById("saving");
  let saveTitle = document.getElementById("dynami-save")
  // Calculate spending
  ...
  if (calculateSpending > incomeAmount) {
    calculateSaving = calculateSpending - incomeAmount;
    save.textContent = `-₹${calculateSaving}`;
    save.style.color = "red";
    saveTitle.innerHTML = "Borrow";
  } else {
